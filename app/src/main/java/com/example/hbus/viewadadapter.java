...
public class viewadadapter extends RecyclerView.Adapter<viewadadapter.ViewHolder> {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (ds.getKey().equals(id)) {
                        nam[0] = user.fullname;
                        //holder.author.setText("Stoppings:  " +nam[0]);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.date.setText("Time: "+story.date);
        holder.author.setText("Stoppings:  " +story.story);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View v) {
            ...
            views = (TextView) v.findViewById(R.id.time);
