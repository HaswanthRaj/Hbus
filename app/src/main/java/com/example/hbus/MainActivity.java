...
import com.example.hbus.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SelectListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.createbutton:
                startActivity(new Intent(this, com.example.hbus.createstory.class));
                break;
        }
    ...
    public void onItemClicked(Story story) {
        Intent intent = new Intent(this, com.example.hbus.storyread.class);
    ...
    protected void onStart() {
        ...
        if (mAuth.getCurrentUser() == null) {
            startActivity(new Intent(this, com.example.hbus.login.class));
            finish();
        }else{
